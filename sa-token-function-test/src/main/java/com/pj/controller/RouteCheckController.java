...
public class RouteCheckController {
    ...
    // 路由测试1   ---- http://localhost:8081/route-check/getInfo1
    @RequestMapping("getInfo1")
    public AjaxJson getInfo1() {
        return AjaxJson.getSuccess();
    }

    // 路由测试2   ---- http://localhost:8081/route-check/getInfo2
    @RequestMapping("getInfo2")
    public AjaxJson getInfo2() {
        return AjaxJson.getSuccess();
    }

    // 路由测试3   ---- http://localhost:8081/route-check/getInfo3
    @RequestMapping("getInfo3")
    public AjaxJson getInfo3() {
        return AjaxJson.getSuccess();
    }

    // 路由测试4   ---- http://localhost:8081/route-check/getInfo4
